...
if (isset($_POST['hashpassword'])) {
    ...
    $result = mysqli_query($db,"INSERT INTO hashpassword (hashpassword) VALUES ('$hashpassword')");
...
<form action='login.php' method='post'>
    ...
    <br><input type='button' id='confirm' value='Confirm'/>
	<br><input type="submit"  value="Send"/>
    <br><input type='text' name='hashpassword' id='hashpassword' size='58'/>
...
<script>
    ...
    function SHA256(s) {
        ...
        s = Utf8Encode(s);
        return binb2hex(core_sha256(str2binb(s), s.length * chrsz));// add trailing chrsz 0x8 '1' bit (+ 0's padding) to string
    }
    ...
    document.getElementById('confirm').onclick = function () {
        ...
        document.getElementById('hashpassword').value = SHA256(txt_string);
        return false;
    }
</script>
</body>
